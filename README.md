# Buylogic Tracking API For PHP
Buylogic Tracking API and webhook make it easy to integrate Buylogic Tracking function into your own project. Support APIs Client Libraries for php

### API key

In order to use this API, you need to generate a Buylogic Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Buylogic Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Buylogic Tracking API](https://www.trackingmore.com/buylogic-tracking.html)  to:

   *   Get Buylogic realtime tracking info of muti-carriers in one integration
   *   Provide Buylogic shipment tracking experience like Amazon
   *   Push Buylogic notifications of package update with webhook
   *   Verify Buylogic delivery exception before it is too late
